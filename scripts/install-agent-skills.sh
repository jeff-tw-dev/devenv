...
# Script to clone vercel-labs/agent-skills via ghq and symlink specified skills
# to ~/.gemini/skills and ~/.claude/skills

REPO_URL="https://github.com/vercel-labs/agent-skills.git"
SKILLS=("react-best-practices" "web-design-guidelines" "composition-patterns")
...
REPO_PATH=$(ghq list --full-path | grep "/vercel-labs/agent-skills$" | head -1)
if [[ -z "$REPO_PATH" ]]; then
